...
import uce.edu.ec.PersistenciaTiendaMusical.controllers.UseradminController;
...
@Autowired
public RegisterScreen(UseradminController useradminController) {
    this.controller = useradminController;
